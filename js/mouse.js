function main2()
{
    ...
    window.addEventListener('mousemove', (e) => {
        ...
        if(bandera=='v')
        {
            cursor.style.backgroundColor = 'rgb(255,255,255,1)'
    ...
    secondContainer.addEventListener('mousemove', () =>
    {
        bandera = 'f'
    })

    thirdContainer.addEventListener('mousemove', () =>
    {
        bandera='f'
    })

    lastContainer.addEventListener('mousemove', () =>
    {
        bandera='f'
    })
